<template>
	...
	<a-layout-sider
		...
		:style="{ backgroundColor: 'transparent',}">
			<div class="brand"><img src="images/logo-ct-black.png" alt=""> <span>Excel BOP Ayang</span></div>
			<hr>
			...
			<a-menu theme="light" mode="inline">
				...
				<a-menu-item>
					<router-link to="/customize-buku">
						...
						<span class="label">Customize Form Buku</span>
					</router-link>
				</a-menu-item>
				<a-menu-item class="menu-item-header">
					Cetak
				...
				<a-menu-item>
					<router-link to="/tables">
						...
						<span class="label">Tanda Penerimaan</span>
					</router-link>
				</a-menu-item>
				<!-- <a-menu-item>
					<router-link to="/rtl">
